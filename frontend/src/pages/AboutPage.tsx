    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <main className="relative mx-auto max-w-6xl px-4 pt-28 pb-20 md:px-6">
        ...
        <Reveal className="mb-16 text-center">
          ...
          <h1 className="mt-5 text-4xl font-sans font-semibold tracking-tight md:text-5xl lg:text-6xl">
        ...
        <Reveal delay={0.05} className="mb-16 rounded-2xl border border-border bg-card shadow-sm overflow-hidden p-0">
          <div className="grid md:grid-cols-5">
            <div className="md:col-span-3 p-8 md:p-12 flex flex-col justify-center">
              <h2 className="text-2xl font-sans font-bold tracking-tight mb-4 text-[#1E1F1B]">The Story</h2>
        ...
        {/* Values */}
        <div className="mb-16">
          <h2 className="text-2xl font-sans font-semibold tracking-tight text-center mb-8">What Guides It</h2>
              ...
              <Reveal key={v.title} delay={i * 0.08}>
                <SpotlightCard className="h-full">
                  <div className="rounded-3xl p-6">
                    ...
                    <h3 className="text-base font-sans font-semibold">{v.title}</h3>
        ...
        <Reveal className="rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 via-background to-accent/10 p-10 text-center">
          ...
          <h2 className="text-2xl font-sans font-semibold tracking-tight md:text-3xl">
