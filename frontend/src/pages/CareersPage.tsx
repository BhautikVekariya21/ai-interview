  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <main className="relative mx-auto max-w-5xl px-4 pt-28 pb-20 md:px-6">
        ...
        {/* Perks */}
        <div className="mb-14">
          <h2 className="text-xl font-sans font-semibold tracking-tight text-center mb-6">Why Contribute</h2>
        ...
        {/* Ways to contribute */}
        <div className="mb-14">
          <h2 className="text-xl font-sans font-semibold tracking-tight text-center mb-6">Ways to Contribute</h2>
                ...
                <SpotlightCard className="group">
                  <div className="rounded-3xl p-6">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        <h3 className="text-lg font-sans font-semibold tracking-tight">{job.title}</h3>
        ...
        <Reveal className="rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-background to-accent/5 p-8 text-center">
          <h3 className="text-lg font-sans font-semibold tracking-tight">Want to Help or Just Chat?</h3>
